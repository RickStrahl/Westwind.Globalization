...
namespace WestWind.Globalization.Sample.AspNetCore
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IConfiguration configuration, IOptions<DbResourceConfiguration> localizationConfig)
        {
