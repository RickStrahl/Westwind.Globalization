...
namespace Westwind.Globalization.Sample.Properties
{
    ...
    public class LocalizationForm
    {
        ...
        public static System.String YouAreAboutToDeleteThisProject
        {
            get
            {
                return GeneratedResourceHelper.GetResourceString("LocalizationForm", "YouAreAboutToDeleteThisProject", ResourceManager, GeneratedResourceSettings.ResourceAccessMode);
            }
        }
